...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.latitude = 39.983497;
    self.longitude = 116.318042;
    
    UITabBarController* tabBarController = [[UITabBarController alloc] init];
    HWHomeViewController* homeViewController = [[HWHomeViewController alloc] init];
    ...
    UITabBarItem * item1 = [[UITabBarItem alloc] initWithTitle:@"首页"
                                        ...
                                        imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]
                                                 selectedImage:[[UIImage imageNamed:@"42"]
                                        imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
